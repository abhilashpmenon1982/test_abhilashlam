...
], function (BaseController, Filter, FilterOperator, JSONModel, MessageBox, Fragment, MessageToast) {
    ...
    return BaseController.extend("lam.fin.ar.controller.Add", {
        ...
        onPopupConfirm: function (oEvent) {
            ...
            if (sId.indexOf("supplier") !== -1) {
                ...
                //this.getView().getModel('prod').setProperty("/prodData/SupplierName",sVal);
